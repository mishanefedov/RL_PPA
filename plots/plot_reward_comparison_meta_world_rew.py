...
# number_rows = 44000000
values_combined = 300
monitor = np.loadtxt("plots/pick_place_mw_reward_monitor.csv", delimiter=',', skiprows=2, usecols=(0,1,2,4))
